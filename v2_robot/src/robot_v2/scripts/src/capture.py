...
class QtCapture(QWidget):
    def __init__(self, *args):
        ...
        self.pub = rospy.Publisher('do_inference_topic', String, queue_size=10)
    ...
    def nextFrameSlot(self):
        if self.isCameraOpen:
            ...
            if self.readyToSave:
                ...
                matt_path = os.getcwd() + '/src/fileName' + '/' + '%05d.jpg' % self.ith_frame
                # cv2.imwrite('./src/fileName' + '/' + '%05d.jpg' % self.ith_frame, frame)
                cv2.imwrite(matt_path, frame)
